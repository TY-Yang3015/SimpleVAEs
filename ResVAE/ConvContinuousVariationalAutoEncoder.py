...
from ConvContinuousDecoder import ConvContinuousDecoder


class ConvContinuousVariationalAutoEncoder:
    def __init__(
            self,
    ...
    def _train_step(self,
                    x: tf.Tensor,
                    val_x: tf.Tensor) -> Tuple[tf.Tensor, tf.Tensor]:
